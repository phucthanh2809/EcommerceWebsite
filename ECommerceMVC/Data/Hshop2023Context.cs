...
//        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=Hshop2023;Persist Security Info=True;User ID=sa;Password=123;Encrypt=True;Trust Server Certificate=True");
